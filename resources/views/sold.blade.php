<x-app-layout>
    ...
    <div class="flex">
        ...
        <div class="container mx-auto p-4 text-gray-800 dark:text-white">
            <h1 class="text-2xl font-bold mb-4"><b>Sold Items</b></h1>
            <div class="mb-6">
                @if(session('success'))
            ...
            @else
                <table class="w-full border-collapse border border-gray-300 dark:border-gray-700">
                    <thead>
                        <tr>
                            <th class="border border-gray-300 dark:border-gray-700 p-2">Buyer</th>
                    ...
                    <tbody>
                        @foreach ($transactions as $transaction)
                            <tr>
                                <td class="border border-gray-300 dark:border-gray-700 p-2">{{ $transaction->buyer->name }}</td>
